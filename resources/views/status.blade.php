...
<div class="container-fluid mt-3">
    ...
    @endif
    <x-adminlte-callout theme="success" title="STATUS PENDAFTAR" style="background-color: #ccc">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <x-adminlte-info-box title="Pondok" text="{{ $pondok }}" icon="fas fa-lg fa-building text-light" icon-theme="gradient-blue"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
