                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" role="button"
                                        href="/admin/pendaftar/edit/{{ $d->id }}"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <a href="/admin/pendaftar/hapus/{{ $d->id }}" class="btn btn-danger btn-sm"
                                        onclick="return confirm('Yakin menghapus data atas nama {{ $d->tahun }} ?')"><i
