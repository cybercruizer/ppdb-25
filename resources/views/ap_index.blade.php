...
@section('content')
    <div class="card">
        <div class="card-header">
            <a href="/admin/pendaftar/export/excel" class="btn btn-labeled btn-success my-3" target="_blank"><span
                            ...
                            @foreach ($siswa as $key => $s)
                                <tr>
                                    ...
                                    <td><a class="btn btn-info btn-sm" role="button"
                                        ...
                                        <a href="/admin/pendaftar/hapus/{{ $s->id }}" class="btn btn-danger btn-sm"
                                            onclick="return confirm('Yakin menghapus data atas nama {{ $s->nama }} ?')"><i
                                                class="far fa-trash-alt"></i></a>
                                        <a class="btn btn-success btn-sm" role="button"
                                            href="https://wa.me/+62{{ $s->no_telp }}">WA</a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
